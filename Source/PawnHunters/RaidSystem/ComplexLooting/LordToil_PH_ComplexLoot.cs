...
/// </summary>
public class LordToil_PH_ComplexLoot : LordToil
{
    ...
    public override void UpdateAllDuties()
    {
        foreach (Pawn p in lord.ownedPawns)
        {
            ...
            p.mindState.duty = new PawnDuty(PawnHuntersDefOf.PH_ComplexLooterDuty);
        }
    }
    ...
    public override void LordToilTick()
    {
        ...
        var lordJob = (LordJob_PH_ComplexLooting)lord.LordJob;
        Map map = lord.Map;
