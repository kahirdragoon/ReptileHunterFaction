...
/// <summary>
/// Kidnapping sequence — the "safe to move" gate is handled in LordToil_PH_Assault
...
/// </summary>
public class JobDriver_PH_KidnapAndFlee : JobDriver
{
    ...
    public override IEnumerable<Toil> MakeNewToils()
    {
        ...
        // job.count = 1 is set by JobGiver_PH_KidnapDowned.
