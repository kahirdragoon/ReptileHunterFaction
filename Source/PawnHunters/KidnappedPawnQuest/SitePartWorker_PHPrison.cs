...
public class SitePartWorker_PHPrison : SitePartWorker
{
        ...
        Dictionary<string, string> outExtraDescriptionConstants)
    {
        ...
        {
            // No kidnapped pawn — the prison spawns as a generic PH holding facility.
